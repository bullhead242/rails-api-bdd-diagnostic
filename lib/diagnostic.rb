...
# Behavior Driven Development is centered around the feature, and if those features
...
RSpec.describe 'Examples API' do
  describe 'GET /examples' do
    it 'lists all examples' do
      ...
      examples = JSON.parse(examples.body)
      expect(examples.length).to eq(examples.count)
      expect(examples.first['title']).to eq(example['title'])
    end
  end
end
